...
<html amp lang="pt-br">
  <head>
    ...
    <style amp-custom>
    body{font-family: 'Roboto'}.content{padding: 0 15px;}.logo{padding: 15px;background: #005ba0}h1{padding: 0 15px;}footer{color: #fff; padding: 30px 15px; background-color: #222; bottom: 0; width: 100%; border-top: 3px solid #005ba0;}.contato{font-size: 16px; width: 20px;}.social{font-size: 25px; padding: 5px 10px 5px 10px;}
    </style>
    ...
    <!-- Importação ícones social media -->
  ...
  <body>
	...
	<!-- Amp ADS -->
	<amp-ad width=300 height=60
		layout="responsive"
		type="doubleclick"
	    data-slot="imagens/pa_outubro.png">
	</amp-ad>
	<div class="content">
    	<?php echo nl2p( wp_strip_all_tags( get_the_content() ) ); ?>
    </div>
    <!-- Amp ADS -->
	<amp-ad width=300 height=60
		layout="responsive"
